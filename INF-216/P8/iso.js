...
class Example extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('tiles', './isometric-grass-and-water.png', {
            frameWidth: 64,
            frameHeight: 64,
        });
        this.load.spritesheet('skeleton', './skeleton8.png', {
            frameWidth: 128,
            frameHeight: 128,
        });
    ...
    create() {
        ...
        agente = this.add.existing(
            new Skeleton(this, 800, 150, 'walk', 'south', 600)
        );
